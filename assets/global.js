...
class MenuDrawer extends HTMLElement {
  ...
  openMenuDrawer(summaryElement) {
    ...
    document.body.classList.add('menu-drawer__open');
  }
  ...
  closeMenuDrawer(event, elementToFocus = false) {
    ...
    document.body.classList.remove('menu-drawer__open');
...
window.addEventListener('load', () => {
  const marqueeObjects = document.querySelectorAll('.scrolling-text-bar');
  marqueeObjects.forEach((element) => {
    const marqueeSpeed = element.getAttribute('data-speed');
    Marquee(element, marqueeSpeed);
  });
});
